...
|     DVC     |                                              Software de versionamento de dados                                              |
...
- **Versionamento de Dados**: Utilização do DVC para o rastreio e versionamento de arquivos CSV e Markdown, mantendo-os fora do banco de dados relacional.
...
- **Visualização (Preview)**: Para garantir a performance, o sistema utiliza _streaming_ de arquivos para ler e exibir apenas as primeiras linhas dos CSVs, evitando o carregamento total de arquivos extensos no navegador.
